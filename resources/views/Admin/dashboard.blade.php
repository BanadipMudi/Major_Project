...
<body>
            ...
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                ...
                <ul class="navbar-nav mr-lg-2">
                    <li class="nav-item nav-search d-none d-lg-block">
                        <h3 class="text-dark" style="font-family: 'Times New Roman', Times, serif;"><b>DASHBOARD</b></h3>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <img src="{{ asset('nancy_css\images\avatar.jpg') }}" alt="profile" />
                            <span class="mx-2">{{session('admin_name')}}</span>
                        </a>
                    ...
                    <div class="row ">
                        <div class="col-md-12 grid-margin ">
                            <div class="card bg-white p-4"> 
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4 mb-4 pt-3 stretch-card transparent">
                                            <div class="card card-tale ">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-4 text-center px-2 ">
                                                            <i class="fa-sharp fa-solid fa-pen px-3"
                                        ...
                                        <div class="col-md-4 mb-4 stretch-card transparent pt-3">
                                            <div class="card card-dark-blue">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-4 text-center px-2 ">
                                                            <i class="fa-solid fa-comment px-3" style="font-size: 75px;"></i>
                                                        </div>
                                                        <div class="col-md-8 text-center py-3">
                                                            <p class="mb-4"
                                                                style="font-size: 30px;font-family: 'Times New Roman', Times, serif;">
                                                                ANSWERS</p>
                                                            <p class="fs-30 mb-2">{{ $count2 }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4 mb-4 stretch-card transparent pt-3">
                                            <div class="card card-light-danger">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-4 text-center px-2 ">
                                                            <i class="fa-solid fa-user-group px-3" style="font-size: 75px;"></i>
                                                        </div>
                                                        <div class="col-md-8 text-center py-3">
                                                            <p class="mb-4"
                                                                style="font-size: 30px;font-family: 'Times New Roman', Times, serif;">
                                                                REPORTS</p>
                                                            <p class="fs-30 mb-2">{{ $count3 }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-md-12 d-flex justify-content-between ">
                                            ...
                                            <h3 class="text-secondary"><b>YOUR TOPIC : {{session('admin_catagory_name')}}</b> </h3>
                                             <!-- <a href="/admin/choice" class=""><b>CHANGE HERE</b></a> -->
                   ...
                   <!-- ------------------------- progress bar------ -->
                    <div class="row my-3  ">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card text-dark bg-white mb-3 position-relative">
                                <div class="card-body">
 ...
 <script>
    ...
    let questionCount2 = {{ $count2 }};
    let questionCount3 = {{ $count3 }};
    // Use the questionCount value in your JavaScript code
</script>
